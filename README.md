...
**Estado atual:** desenvolvimento aberto. O ciclo metodológico completo — PPC-001 a PPC-008 —, a Teoria da Mudança, suas fichas práticas e os padrões iniciais de governança documental já estão publicados para revisão, teste e aplicação experimental. As migrações documentais da governança e dos dez documentos da camada de método foram concluídas. Nove das onze ferramentas estão conformes ao padrão de metadados, após a conclusão dos lotes 3A e 3B. Ainda não há estudo de caso oficial publicado.
