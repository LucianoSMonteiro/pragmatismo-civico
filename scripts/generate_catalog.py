...
LAYER_BY_PATH = {
    ...
    "casos/CASO-001_DOCUMENTOS_TECNICOS_E_CONTRATACOES.md": "Aplicações e evidências",
    "casos/CASO-001_PROTOCOLO_DE_GEOMETRIA_E_DELIMITACAO.md": "Aplicações e evidências",
