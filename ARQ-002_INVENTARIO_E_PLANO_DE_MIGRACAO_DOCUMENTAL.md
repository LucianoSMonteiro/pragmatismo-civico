...
|---|---|---:|
| Página inicial | `PORTAL-INICIO` | 0.3.0 |
| Guia de início | `GUIA-COMECAR` | 0.3.0 |
...
A execução `29632835536`, no commit `92e9158121422f0ceae7f5e09fba7a15ab020f55`, foi aprovada com:
...
Dois status de commit são registrados:

- `documentation/validation`;
- `portal/build`.

O relatório `validation-report` é preservado como artefato por 14 dias, inclusive em execuções reprovadas.
...
- a CI deve preservar relatório mesmo quando reprovada;
- falhas documentais e falhas de build possuem status distintos;
...
| 0.16.0 | 2026-07-18 | compatível | Conclusão da Fase 6, validação de metadados, relações, links, histórico, catálogo e build com relatório persistente | Projeto Pragmatismo Cívico |
