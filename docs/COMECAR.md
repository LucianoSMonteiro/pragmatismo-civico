...
Comece pelo [Framework de Referência](../FRAMEWORK_DE_REFERENCIA.md), que apresenta a arquitetura do conhecimento, a hierarquia documental e a regra de preservação da essência.
...
- os riscos de complexidade, captura ou descaracterização do framework;
