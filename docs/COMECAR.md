...
7. [GOV-008](../GOV-008_PROTOCOLO_DE_SELECAO_E_CONDUCAO_DE_CASOS.md) — seleção e condução de casos;
8. [Cadastro de Revisores](../CADASTRO_PUBLICO_DE_REVISORES.md) — registro público, atualmente vazio;
9. [ARQ-001](../ARQ-001_ARQUITETURA_DOCUMENTAL_DO_FRAMEWORK.md) — camadas;
10. [ARQ-002](../ARQ-002_INVENTARIO_E_PLANO_DE_MIGRACAO_DOCUMENTAL.md) — cobertura e dívida;
11. [ARQ-003](../ARQ-003_DECISAO_SOBRE_A_ESTRUTURA_FISICA_DO_REPOSITORIO.md) — estrutura física.
